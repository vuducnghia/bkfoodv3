...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Mon_an.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Hoa_don.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Hoa_don.class.getName() + ".as", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Mon_an_da_mua.class.getName(), jcacheConfiguration);
